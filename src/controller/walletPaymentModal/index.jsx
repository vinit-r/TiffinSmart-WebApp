...
const WalletPaymentModal = (props) => {
  const { toggleUpiOrWalletModal, showUpiOrWalletModal, type } = props;

  return (
    <>
      <Modal
        isOpen={showUpiOrWalletModal}
        onRequestClose={() => toggleUpiOrWalletModal()}
            ...
            <div className="w-full pb-16">
              <p className="flex justify-between items-center text-xl md:text-xl lg:text-2xl sm:font-bold font-semibold bg-black text-white w-full py-5 px-5 border-b-4 border-gray-500">
                <span
                  ...
                  onClick={() => toggleUpiOrWalletModal()}
                >
                  X
                </span>
                {type === "wallet" ? (
              ...
              <div className=" px-3 sm:px-6 md:px-10 py-2 sm:py-8 w-full">
                ...
                <div className="pt-3 sm:pt-5">
                  {type === "wallet" ? (
                    ...
                    <div className="pt-5 text-theme-color font-semibold sm:font-bold text-lg sm:text-xl ">
                      Enter Your UPI ID
                    </div>
                  )}
                </div>
                ...
                <div className="pt-2 sm:pt-5 flex flex-col items-center gap-2 w-full">
                  ...
                  {type === "upi" && (
                    <p className="flex items-center w-full sm:gap-5 gap-3">
                      <input
                        type="checkbox"
